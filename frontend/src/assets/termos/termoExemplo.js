export default {
  conteudo: `<h1>Terms and Conditions</h1>
...
<ul>
      ...
      <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Psi Para Todos.</li>
  ...
  <li><strong>Website</strong> refers to Psi Para Todos, accessible from psiparatodos.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
</ul>
...
<ul>
        <li>By email: psiparatodos@gmail.com</li>
        </ul>`
}
